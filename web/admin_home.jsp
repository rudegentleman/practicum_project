...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- Code that fetches the menu for admin. This will be different for each user. -->
        <jsp:include page="includes/admin_menu.jsp" />
      <!-- End of include for admin menu -->
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
        <jsp:include page="includes/admin_main_content.jsp" />
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
